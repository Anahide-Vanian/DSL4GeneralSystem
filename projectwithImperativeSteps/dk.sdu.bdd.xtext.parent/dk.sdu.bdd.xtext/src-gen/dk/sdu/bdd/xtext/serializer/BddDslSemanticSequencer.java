...
public class BddDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_DeclarativeScenarioAction(ISerializationContext context, DeclarativeScenarioAction semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BddDslPackage.Literals.DECLARATIVE_SCENARIO_ACTION__ACTIONS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BddDslPackage.Literals.DECLARATIVE_SCENARIO_ACTION__ACTIONS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDeclarativeScenarioActionAccess().getActionsDeclarativeActionPhraseParserRuleCall_0(), semanticObject.getActions());
		feeder.finish();
	}
	...
	protected void sequence_DeclarativeScenarioState(ISerializationContext context, DeclarativeScenarioState semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BddDslPackage.Literals.DECLARATIVE_SCENARIO_STATE__STATES) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BddDslPackage.Literals.DECLARATIVE_SCENARIO_STATE__STATES));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDeclarativeScenarioStateAccess().getStatesDeclarativeStatePhraseParserRuleCall_0(), semanticObject.getStates());
		feeder.finish();
	}
	...
	protected void sequence_ImperativeStateName(ISerializationContext context, ImperativeStateName semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getImperativeStateNameAccess().getNameWORDParserRuleCall_0_0(), semanticObject.getName());
		feeder.finish();
	}
